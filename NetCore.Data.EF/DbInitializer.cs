    ...
    public class DbInitializer
    {
                ...
                public async Task Seed()
        {
            ...
            if (_context.ProductCategories.Count() == 0)
            {
                ...
                {
                    new ProductCategory() { Name="Men shirt",SeoAlias="men-shirt",ParentId = null,Status=Status.Active,SortOrder=1, DateCreated=DateTime.Now,DateModified=DateTime.Now,LanguageId=1, Description="Baba men",
                    ...
                    new ProductCategory() { Name="Women shirt",SeoAlias="women-shirt",ParentId = null,Status=Status.Active ,SortOrder=2,DateCreated=DateTime.Now,DateModified=DateTime.Now,LanguageId=1,  Description="Baba men",
                        Products = new List<Product>()
                        {
                    ...
                    new ProductCategory() { Name="Men shoes",SeoAlias="men-shoes",ParentId = null,Status=Status.Active ,SortOrder=3,DateCreated=DateTime.Now,DateModified=DateTime.Now,LanguageId=1, Description="Baba men",
                        Products = new List<Product>()
                        {
                    ...
                    new ProductCategory() { Name="Woment shoes",SeoAlias="women-shoes",ParentId = null,Status=Status.Active,SortOrder=4,DateCreated=DateTime.Now,DateModified=DateTime.Now,LanguageId=1, Description="Baba men",
                        Products = new List<Product>()
                        {
