        ...
        $("#fileImage").on('change', function () {
            ...
            $.ajax({
                ...
                success: function (path) {
                    ...
                    netcore.notify('Đã tải ảnh lên thành công!', 'success');
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.each(response, function (i, item) {
                    render += '<div class="col-md-3"><img width="100"  data-path="' + item.Image + '" src="' + item.Image + '"><br/><a href="#" class="btn-delete-image">Xóa</a></div>'
                });
