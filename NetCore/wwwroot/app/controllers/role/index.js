    ...
    function registerEvents() {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        netcore.notify('Update role successful', 'success');
                    ...
                    error: function () {
                        netcore.notify('Has an error', 'error');
                        netcore.stopLoading();
                    }
                });
                return false;
        ...
        $('body').on('click', '.btn-delete', function (e) {
            ...
            netcore.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    success: function (response) {
                        netcore.notify('Delete successful', 'success');
                        netcore.stopLoading();
                        loadData();
                    },
                    error: function (status) {
        ...
        $("#btnSavePermission").off('click').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    netcore.notify('Save permission successful', 'success');
                    $('#modal-grantpermission').modal('hide');
                    netcore.stopLoading();
                },
                error: function () {
                    netcore.notify('Has an error in save permission progress', 'error');
                    netcore.stopLoading();
                }
            });
        });
