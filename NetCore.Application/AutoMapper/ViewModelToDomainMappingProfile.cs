    ...
    public class ViewModelToDomainMappingProfile:Profile
    {
        public ViewModelToDomainMappingProfile()
        {
            CreateMap<ProductCategoryViewModel, ProductCategory>().
                ConstructUsing(x => new ProductCategory(x.Name, x.ParentId, x.Description, x.Content, x.Image, x.Icon, x.HomeFlag, x.SortOrder, x.DateCreated, x.DateModified, x.SeoAlias, x.TitleMeta, x.KeywordMeta, x.DescriptionMeta, x.LanguageId, x.Status));
